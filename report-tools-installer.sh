...
echo -e "    Mở Codex hoặc Claude trong repo này và nhập prompt."
echo -e "    Dòng 1: yêu cầu báo cáo, ví dụ report, báo cáo tuần, report weekly, báo cáo tuần W30"
echo -e "    Dòng 2+: nội dung cột Note, có thể ghi bất kỳ như kế hoạch hoặc vấn đề trong tuần"
echo ""
echo -e "    Ví dụ:"
echo -e "      báo cáo tuần W30"
echo -e "      Kế hoạch tuần tới: hoàn thiện flow thanh toán"
echo -e "      Vấn đề trong tuần: chờ API từ backend"
echo ""
