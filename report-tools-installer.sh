...
echo -e "╚══════════════════════════════════════════╝${RESET}"
echo -e "${CYAN}Version: ${BOLD}v${TOOL_VERSION}${RESET}"
echo ""
...
echo -e "${CYAN}📌  Phiên bản đã cài: ${BOLD}v${TOOL_VERSION}${RESET}"
echo ""
...
echo -e "    Mở Codex hoặc Claude trong repo này và nhập bắt buộc đúng prompt 3 dòng."
...
echo ""
echo -e "    Nếu thiếu dòng 2/dòng 3 hoặc có hơn 3 dòng không rỗng, tool sẽ yêu cầu nhập lại."
echo -e "    Preview/xem trước: thêm preview hoặc xem trước ở dòng 1."
echo -e "    Claude slash command: /report"
echo ""
...
echo -e "    python .team-tools/report.py --performance-file /path/to/report-prompt.txt"
echo -e "    # report-prompt.txt gồm đúng 3 dòng: report / Vấn đề / Plan tuần tới"
echo ""
